...
def std(x, /, *, axis=None, correction=0.0, keepdims=False):
    xp = x.arr.__array_namespace__()
    return _reduction_operation(x, axis, xp.std, keepdims=keepdims, correction=correction)
...
def var(x, /, *, axis=None, correction=0.0, keepdims=False):
    xp = x.arr.__array_namespace__()
    return _reduction_operation(x, axis, xp.var, keepdims=keepdims, correction=correction)

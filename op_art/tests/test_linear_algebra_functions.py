...
def test_matmul_1x2():
    ...
    assert_array_equal(
        c.arr, np.matmul(np.array([1, 2, 3]), np.array([[5, 1], [0, 3], [2, 4]]))
    )
...
def test_matmul_2x1():
    ...
    assert_array_equal(
        c.arr, np.matmul(np.array([[0, 1, 2], [3, 4, 5]]), np.array([1, 2, 3]))
    )
...
def test_matmul_2x2():
    ...
    assert_array_equal(
        c.arr,
        np.matmul(np.array([[0, 1, 2], [3, 4, 5]]), np.array([[5, 1], [0, 3], [2, 4]])),
    )
    assert_array_equal(
        c.src_arr_ids,
        [
    ...
    assert_array_equal(
        c.src_offsets,
        [
            [[0, 1, 2, 0, 2, 4], [0, 1, 2, 1, 3, 5]],
            [[3, 4, 5, 0, 2, 4], [3, 4, 5, 1, 3, 5]],
        ],
    )
